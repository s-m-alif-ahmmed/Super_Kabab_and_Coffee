...
{{--        <div>--}}
{{--            <img src="{{ $user->photo}}" alt="" class="rounded-5 h-25 w-100">--}}
{{--        </div>--}}

{{--        <div>--}}
{{--            <x-input-label for="photo" :value="__('Profile Photo')" />--}}
{{--            <x-text-input id="photo" name="photo" type="file" class="mt-1 block w-full" :value="old('photo', $user->photo)" required autofocus autocomplete="photo" />--}}
